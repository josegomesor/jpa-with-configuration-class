...
public class JpaConfigTest {
	...
	private static final Logger LOG = LoggerFactory.getLogger(JpaConfigTest.class);
	@Autowired
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan("com.josky.jpawithconfigurationclass");
